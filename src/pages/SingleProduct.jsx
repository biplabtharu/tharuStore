  ...
  return (
    <>
      <Wrapper className="wrapper">
          <p className="nav_para"><NavLink to="/">Home</NavLink>/{title}</p>
        <div className="container">
          <div className="single_product_section">          
                ...
                <div className="single_product_desc">
                  ...
                  <Star stars={rating}/>
                  <div className="price">
                    <p>MRP: <del> <NumberFormatMrp price={price} /> </del></p>
                    <span>Deal of the day: <NumberFormat price={price}/></span>
                  </div>

                  <p>{description}</p>

                  <hr/>
                  <p>Available: <span className="stock_para">{stock>0? "In stock" : "Not available"}</span></p>
                  <p>ID: <span className="stock_para">{id}</span></p>
                  <p>brand: <span className="stock_para">{brand}</span></p>
                <hr/>
